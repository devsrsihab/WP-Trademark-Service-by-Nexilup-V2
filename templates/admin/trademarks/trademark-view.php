    ...
    <div class="tm-trademark-details-container" style="display: flex; gap: 20px;">
        ...
        <div class="tm-sidebar" style="flex: 1;">
                ...
                <table class="form-table" role="presentation">
                    <tbody>
                        <tr>
                            ...
                            <td><a href="<?php echo admin_url('post.php?post=' . $order->get_id() . '&action=edit'); ?>">#<?php echo $order->get_id(); ?></a></td>
                        </tr>
                        <tr>
            ...
            <div class="tm-details-section">
                <h2>Actions</h2>
                <p>
                    <a href="?page=tm-trademarks&action=edit&id=<?php echo $id; ?>" class="button button-primary">Edit Trademark</a>
